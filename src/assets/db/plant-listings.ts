...
export const PLANT_LISTINGS: PlantListing[] = [
        ...
        },
        {
            ...
            trapping leaves. The plant required two or more instances of contact within 20 seconds before the trap will close and an addition five triggers once the insect is
            trapped to begin the digestive process. While abundantly available in cultivation, in the wild, the Venus Flytrap is currently under review to be listed as an Endangered
            Species due to its decline of natural habitat.`,
